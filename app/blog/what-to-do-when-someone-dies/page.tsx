...
export const metadata: Metadata = {
  ...
  keywords: 'what to do when someone dies, after death checklist, steps after someone dies, death at home what to do, what to do after a parent dies',
  alternates: {
    canonical: 'https://funeralhomedirectories.com/blog/what-to-do-when-someone-dies',
  },
};
