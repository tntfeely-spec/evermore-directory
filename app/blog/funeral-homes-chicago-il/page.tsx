            ...
            <section className="mb-10">
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse bg-white rounded">
                  ...
                  <tbody>
                    <tr><td className="border p-3">Direct Cremation</td><td className="border p-3">$1,500 – $4,000</td></tr>
                    <tr><td className="border p-3">Cremation with Memorial Service</td><td className="border p-3">$3,500 – $7,000</td></tr>
                    <tr><td className="border p-3">Traditional Burial</td><td className="border p-3">$7,000 – $13,000</td></tr>
                    <tr><td className="border p-3">Full Funeral with Viewing</td><td className="border p-3">$8,500 – $16,000+</td></tr>
