          ...
          <article>
            ...
            <section className="mb-10 bg-slate-50 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/blog/medicaid-funeral-assistance" className="text-slate-600 hover:text-slate-800 font-medium">Medicaid and Funeral Assistance: What Low-Income Famili &rarr;</Link></li>
              </ul>
            </section>
