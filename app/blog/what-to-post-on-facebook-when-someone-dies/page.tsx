...
export default function WhatToPostOnFacebookWhenSomeoneDiesPage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"What to Post on Facebook When Someone Dies: Examples and What to Avoid","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-16","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/what-to-post-on-facebook-when-someone-dies"}) }} />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <article>
            ...
            <section className="mb-10 bg-slate-50 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                <li><Link href="/blog/announcing-death-on-social-media" className="text-slate-600 hover:text-slate-800 font-medium">Announcing a Death on Social Media: What to Post and Ho &rarr;</Link></li>
                <li><Link href="/blog/how-to-write-an-obituary" className="text-slate-600 hover:text-slate-800 font-medium">How to Write an Obituary &rarr;</Link></li>
                <li><Link href="/blog/condolence-text-message" className="text-slate-600 hover:text-slate-800 font-medium">Condolence Text Messages: What to Write and What to Avo &rarr;</Link></li>
              </ul>
            </section>
