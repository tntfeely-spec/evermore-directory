...
export default function EuropeanFuneralTraditionsPage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"European Funeral Traditions: Irish, Italian, Greek Orthodox, and More","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-14","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/european-funeral-traditions"}) }} />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <article>
            ...
            <section className="mb-10 bg-slate-50 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                <li><Link href="/blog/african-american-funeral-traditions" className="text-slate-600 hover:text-slate-800 font-medium">African American Funeral Traditions &rarr;</Link></li>
                <li><Link href="/blog/asian-funeral-traditions" className="text-slate-600 hover:text-slate-800 font-medium">Asian Funeral Traditions &rarr;</Link></li>
              </ul>
            </section>
