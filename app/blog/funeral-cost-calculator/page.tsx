...
export const metadata: Metadata = {
  ...
  description: 'Estimate funeral and cremation costs in your state. Real price ranges from 7,395+ funeral homes and cremation providers across all 50 states. Updated 2026.',
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <article>
            <header className="mb-10">
              ...
              <p className="text-xl text-gray-600 mb-4">Real price ranges from 7,395+ funeral homes and cremation providers across all 50 states.</p>
              <div className="flex items-center gap-3 text-sm text-gray-500">
                <span className="font-medium text-gray-700">By Terry</span><span>|</span><span>Last Updated April 2026</span>
              </div>
            </header>
