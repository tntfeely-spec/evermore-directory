          ...
          <article>
            ...
            <section className="mb-10 bg-slate-50 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/blog/obituary-template" className="text-slate-600 hover:text-slate-800 font-medium">Free Obituary Template: Fill in the Blank (Word, PDF, a &rarr;</Link></li>
