...
export default function GriefAfterDivorcePage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Grief After Divorce: Why It Feels Like Loss and How to Cope","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-13","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/grief-after-divorce"}) }} />
