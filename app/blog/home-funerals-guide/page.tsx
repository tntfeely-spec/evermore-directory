...
export default function HomeFuneralsGuidePage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Home Funerals: What They Are and How to Plan One","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-10","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/home-funerals-guide"}) }} />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <article>
            ...
            <section className="mb-10 bg-slate-50 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                <li><Link href="/blog/green-burial-options" className="text-slate-600 hover:text-slate-800 font-medium">Green Burial Options: What They Are and How to Plan One &rarr;</Link></li>
                <li><Link href="/blog/alternative-burial-methods" className="text-slate-600 hover:text-slate-800 font-medium">Alternative Burial Methods: Every Option Beyond Traditi &rarr;</Link></li>
