...
export default function FuneralDirectorCareerPage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Funeral Director Career: Salary, Schooling, and How to Get Started","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-14","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/funeral-director-career"}) }} />
          ...
          <article>
            ...
            <section className="mb-10 bg-slate-50 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/blog/embalming-explained" className="text-slate-600 hover:text-slate-800 font-medium">Embalming: What It Is, What It Costs, and Whether It Is &rarr;</Link></li>
