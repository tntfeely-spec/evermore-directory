...
export default function DeathDoulaGuidePage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Death Doula: What They Do, What It Costs, and How to Find One","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-13","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/death-doula-guide"}) }} />
          ...
          <article>
            ...
            <section className="mb-10 bg-slate-50 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/blog/palliative-care-vs-hospice" className="text-slate-600 hover:text-slate-800 font-medium">Palliative Care vs Hospice: What Is the Difference? &rarr;</Link></li>
                <li><Link href="/blog/signs-of-dying" className="text-slate-600 hover:text-slate-800 font-medium">Signs of Dying: What to Expect in the Final Days and Ho &rarr;</Link></li>
                <li><Link href="/blog/anticipatory-grief" className="text-slate-600 hover:text-slate-800 font-medium">Anticipatory Grief: What It Is and How to Cope &rarr;</Link></li>
              </ul>
            </section>
