...
export default function PallbearerGuidePage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"HowTo","name":"How to Be a Pallbearer","description":"What pallbearers do, what to wear, and how to prepare for the role.","step":[{"@type":"HowToStep","position":1,"name":"Accept or decline promptly","text":"If asked to be a pallbearer respond promptly. It is an honor but also a physical responsibility. If you have physical limitations that would make carrying a casket difficult, it is acceptable to decline and offer to be an honorary pallbearer instead."},{"@type":"HowToStep","position":2,"name":"Coordinate your attire","text":"Wear dark formal attire unless the family specifies otherwise. Men typically wear a dark suit, white or light shirt, and conservative tie. Women wear a dark dress, suit, or slacks. Ask the funeral director if there is a dress code."},{"@type":"HowToStep","position":3,"name":"Arrive early at the funeral home or church","text":"Arrive at least 30 minutes early. The funeral director will brief all pallbearers on the process, positioning, and timing before the service begins."},{"@type":"HowToStep","position":4,"name":"Follow the funeral director's instructions","text":"The funeral director will tell you where to stand, which side to carry, and when to move. Follow their lead throughout. They manage the logistics so you can focus on the moment."},{"@type":"HowToStep","position":5,"name":"Carry with care and dignity","text":"Caskets typically weigh 150 to 400 pounds with 6 pallbearers sharing the load. Walk slowly and in step with the others. Keep your eyes forward and maintain a calm composed expression."},{"@type":"HowToStep","position":6,"name":"Be present for the family after","text":"After the committal service make a point of speaking briefly with the immediate family. Your presence as a pallbearer means a great deal and a few quiet words of comfort are appropriate."}]}) }} />
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Pallbearer Guide: What to Wear, What to Do, and What to Expect","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-10","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/pallbearer-guide"}) }} />
          ...
          <article>
            ...
            <section className="mb-10 bg-slate-50 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/blog/funeral-procession-guide" className="text-slate-600 hover:text-slate-800 font-medium">Funeral Procession: Rules, Etiquette, and What to Do &rarr;</Link></li>
              </ul>
            </section>
