...
export default function MemorialSteppingStonesPage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Memorial Stepping Stones: Ideas, How to Make One, and Where to Buy","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-16","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/memorial-stepping-stones"}) }} />
