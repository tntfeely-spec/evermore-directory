...
export default function ExplainingDeathToChildrenPage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Explaining Death to Children: A Guide by Age","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-13","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/explaining-death-to-children"}) }} />
          ...
          <article>
            ...
            <section className="mb-10 bg-slate-50 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/blog/children-and-grief" className="text-slate-600 hover:text-slate-800 font-medium">Children and Grief: How to Support a Child After a Loss &rarr;</Link></li>
                <li><Link href="/blog/loss-of-parent-guide" className="text-slate-600 hover:text-slate-800 font-medium">Losing a Parent: What to Expect and How to Cope &rarr;</Link></li>
              </ul>
            </section>
