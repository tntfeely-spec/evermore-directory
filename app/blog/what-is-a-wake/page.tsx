...
export default function WhatIsAWakePage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"What Is a Wake? What to Expect, What to Wear, and What to Say","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-14","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/what-is-a-wake"}) }} />
          ...
          <article>
            ...
            <section className="mb-10 bg-slate-50 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/blog/jewish-funeral-etiquette" className="text-slate-600 hover:text-slate-800 font-medium">Jewish Funeral Etiquette for Non-Jews: A Respectful Gui &rarr;</Link></li>
              </ul>
            </section>
