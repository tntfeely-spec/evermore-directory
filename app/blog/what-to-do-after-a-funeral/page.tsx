...
export default function WhatToDoAfterFuneralPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"HowTo","name":"What to Do After a Funeral","description":"The practical steps to take in the days and weeks following a funeral.","step":[{"@type":"HowToStep","position":1,"name":"Send thank you notes","text":"Send handwritten thank you notes within two weeks to those who sent flowers, food, donations, or provided meaningful support during the service."},{"@type":"HowToStep","position":2,"name":"Notify financial institutions","text":"Contact banks, investment accounts, credit card companies, and the deceased's employer. Bring certified copies of the death certificate to each institution."},{"@type":"HowToStep","position":3,"name":"Cancel subscriptions and accounts","text":"Cancel subscriptions, memberships, driver's license, passport, and voter registration. Notify the Social Security Administration if not already done."},{"@type":"HowToStep","position":4,"name":"File life insurance claims","text":"Contact each life insurance company with a certified death certificate and policy number. Claims are typically processed within 30 to 60 days."},{"@type":"HowToStep","position":5,"name":"Probate the will","text":"File the will with the local probate court if required. An estate attorney can guide you through the process depending on the size of the estate."},{"@type":"HowToStep","position":6,"name":"Take care of yourself","text":"Grief is a process. Give yourself time, accept help from others, and consider speaking with a grief counselor if needed."}]}) }} />
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"What to Do After a Funeral: Planning the Gathering and Next Steps","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-10","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/what-to-do-after-a-funeral"}) }} />
