...
export const metadata: Metadata = {
  ...
  description: 'A former paramedic explains why pre-planning a funeral is one of the most generous things you can do for the people who will grieve you -- and exactly how to do it.',
  keywords: 'pre-planning a funeral, pre-need funeral arrangements, funeral pre-planning, funeral planning ahead, pre-need funeral contract',
  alternates: {
    canonical: 'https://funeralhomedirectories.com/blog/pre-planning-a-funeral',
  },
};
