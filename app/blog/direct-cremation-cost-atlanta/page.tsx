...
export const metadata: Metadata = {
  title: 'Direct Cremation Cost in Atlanta, Georgia (2026)',
  description: 'Compare direct cremation costs in Atlanta, Georgia. Real pricing from local providers. Find the most affordable cremation option near you.',
  keywords: 'direct cremation cost atlanta, cremation cost atlanta ga, affordable cremation atlanta, direct cremation atlanta',
  robots: { index: true, follow: true },
  alternates: { canonical: 'https://funeralhomedirectories.com/blog/direct-cremation-cost-atlanta' },
  openGraph: { title: 'Direct Cremation Cost in Atlanta, Georgia (2026)', url: 'https://funeralhomedirectories.com/blog/direct-cremation-cost-atlanta', type: 'article' },
};

export default async function Page() {
  const pricing = await getCityPricing('Atlanta', 'GA');
  ...
  const dataNote = pricing?.dataSource === 'city_supabase'
    ? `Based on real pricing from ${listingCount} funeral homes in Atlanta listed on Evermore Directory.`
    : `Based on state-level Georgia averages where city-specific pricing was not available.`;
  ...
  const faqs = [
    { q: 'How much does direct cremation cost in Atlanta?', a: `Direct cremation in Atlanta ranges from ${cremRange}. ${dataNote} The national average for direct cremation is $1,500 to $3,500.` },
    { q: 'What is the cheapest cremation option in Atlanta?', a: `Direct cremation is the most affordable cremation option in Atlanta, starting around ${pricing ? formatCurrency(pricing.cremationLow) : '$1,500'}. It includes transportation, cremation, and return of remains without a formal service.` },
    { q: 'What is included in direct cremation in Atlanta?', a: 'Direct cremation in Atlanta typically includes transportation of the deceased, a basic cremation container, the cremation process, required permits, and return of cremated remains. It does not include embalming, a viewing, a casket, or a ceremony.' },
    { q: 'How do I find affordable cremation in Atlanta?', a: 'Compare direct cremation providers in Atlanta on Evermore Directory. Request the General Price List from at least three providers. Under the FTC Funeral Rule, every provider must give you one on request. Online cremation providers often have lower prices than traditional funeral homes.' },
    { q: 'Can I have a memorial after direct cremation in Atlanta?', a: 'Yes. Many families in Atlanta choose direct cremation and then hold a separate celebration of life or memorial service weeks or months later. This gives time to plan a meaningful gathering without the pressure of immediate arrangements.' },
  ];

  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Direct Cremation Cost in Atlanta, Georgia (2026)","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-05-12","dateModified":"2026-05-12","url":"https://funeralhomedirectories.com/blog/direct-cremation-cost-atlanta"}) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://funeralhomedirectories.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://funeralhomedirectories.com/blog"},{"@type":"ListItem","position":3,"name":"Direct Cremation Cost in Atlanta, Georgia"}]}) }} />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <article>
            <header className="mb-10">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">Direct Cremation Cost in Atlanta, Georgia (2026)</h1>
              ...
              <p className="text-xl text-gray-600">Real direct cremation pricing for Atlanta, Georgia.</p>
            </header>

            <section className="mb-10">
              <p className="text-gray-700 text-lg leading-relaxed mb-4">
                Direct cremation in Atlanta, Georgia costs between {cremRange}, based on {pricing?.dataSource === 'city_supabase' ? `real pricing from ${listingCount} funeral homes in Atlanta` : `state-level Georgia averages`} listed on Evermore Directory. The national average for direct cremation is $1,500 to $3,500.
              </p>
              <p className="text-gray-600 mb-4">
                Direct cremation is the most affordable cremation option because it eliminates the costs of embalming, a casket, a viewing, and a formal ceremony. The provider handles transportation, the cremation process, permits, and return of ashes. Many Atlanta families choose direct cremation and then plan a memorial or celebration of life on their own schedule.
              </p>
            </section>

            <section className="mb-10">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Direct Cremation Pricing in Atlanta (2026)</h2>
              <div className="overflow-x-auto mb-4">
                <table className="w-full border-collapse">
                  <thead><tr className="bg-gray-50 border-b border-gray-200"><th className="text-left px-4 py-3 font-semibold text-gray-700">Service Type</th><th className="text-left px-4 py-3 font-semibold text-gray-700">{pricing?.dataSource === 'city_supabase' ? 'Atlanta' : 'Georgia State'} Average</th></tr></thead>
                  <tbody>
            ...
            <section className="mb-10">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Direct Cremation Costs Vary in Atlanta</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
                Direct cremation costs in Atlanta depend on several factors. The primary driver is provider overhead: facility costs, staff wages, and regulatory compliance. Urban markets like Atlanta tend to have higher facility costs than rural areas. National chains typically price at or above the local average, while independent providers and online cremation specialists often offer more competitive pricing.
              </p>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section className="mb-10">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">How to Find Affordable Direct Cremation in Atlanta</h2>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start"><span className="text-slate-600 font-bold mr-3">1.</span><span>Compare at least 3 providers. Use the <Link href="/direct-cremation/ga/atlanta" className="text-slate-600 hover:text-slate-800 font-medium">Evermore Directory</Link> to see all direct cremation providers in Atlanta.</span></li>
            ...
            <section className="mb-10">
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/direct-cremation/ga/atlanta" className="inline-block bg-slate-700 hover:bg-slate-800 text-white font-bold px-6 py-3 rounded-lg transition-colors text-center">Browse Cremation Providers in Atlanta</Link>
                <Link href="/funeral-costs/georgia" className="inline-block border border-slate-300 text-slate-700 font-bold px-6 py-3 rounded-lg hover:bg-slate-50 transition-colors text-center">Georgia State Cost Overview</Link>
              </div>
            </section>

            <section className="mb-10">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Compare All Funeral Costs in Atlanta</h2>
              <p className="text-gray-600 mb-4">For a broader comparison including traditional burial and full funeral costs in Atlanta, see our complete cost guide:</p>
              <Link href="/blog/funeral-home-costs-atlanta" className="text-slate-600 hover:text-slate-800 font-medium">Funeral Home Costs in Atlanta, Georgia (2026)</Link>
            </section>
            <section className="mb-10">
