...
export default function DeathCertificateGuidePage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"HowTo","name":"How to Get Death Certificates","description":"How to order certified copies of a death certificate and how many you will need.","step":[{"@type":"HowToStep","position":1,"name":"Work with the funeral home","text":"The funeral home handles the initial death certificate filing with the state. Tell them how many certified copies you need. Order more than you think you need."},{"@type":"HowToStep","position":2,"name":"Order 8 to 12 certified copies","text":"Most estates need 8 to 12 certified copies. Each financial institution, insurance company, and government agency typically requires its own original certified copy."},{"@type":"HowToStep","position":3,"name":"Pay the state fee","text":"Certified copies cost $10 to $25 each depending on the state. The funeral home may handle this or you may order directly from the vital records office."},{"@type":"HowToStep","position":4,"name":"Order additional copies if needed","text":"If you run out, contact your state vital records office directly. You can order additional certified copies at any time after the death is registered."},{"@type":"HowToStep","position":5,"name":"Distribute copies to institutions","text":"Send certified copies to Social Security, banks, life insurance companies, the employer, pension providers, and any creditors or courts that require one."}]}) }} />
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Death Certificates: How Many You Need and How to Get Them","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-10","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/death-certificate-guide"}) }} />
