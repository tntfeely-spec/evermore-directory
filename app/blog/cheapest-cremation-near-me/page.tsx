...
export default function CheapestCremationNearMePage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Cheapest Cremation Near Me: How to Find Low Cost Direct Cremation","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-13","dateModified":"2026-04-13","url":"https://funeralhomedirectories.com/blog/cheapest-cremation-near-me"}) }} />
          ...
          <article>
            ...
            <section className="mb-10 bg-slate-50 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/blog/cremation-vs-burial-cost-tennessee" className="text-slate-600 hover:text-slate-800 font-medium">Cremation vs Burial Cost in Tennessee &rarr;</Link></li>
              </ul>
            </section>
