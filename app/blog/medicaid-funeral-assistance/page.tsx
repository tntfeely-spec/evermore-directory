        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <article>
            ...
            <section className="mb-10">
              ...
              <p className="text-gray-600 leading-relaxed">Direct cremation is often the most affordable option and is typically covered by assistance programs. Direct cremation involves the cremation of the body without a viewing, visitation, or ceremony, and it can cost as little as $500 to $1,500 in many areas. Families who choose direct cremation can then hold a memorial service or celebration of life at a later date without the financial pressure of a full funeral.</p>
            </section>
