...
const categories: { name: string; subtitle?: string; posts: Post[] }[] = [
  ...
  },
  {
    ...
    posts: [
      { slug: 'funeral-cost-calculator', title: 'Funeral Cost Calculator: Estimate Costs by State (2026)', description: 'Real price ranges from 5,100+ funeral homes and cremation providers across all 50 states. Pick your state for instant estimates.' },
  ...
  },
  {
    ...
    posts: [
      ...
      { slug: '/eulogy-writer', title: 'Free AI Eulogy Writer', description: 'Generate a complete, personalized eulogy in minutes. Enter a few details and the AI writes a heartfelt tribute you can deliver.' },
    ],
  },
  {
  ...
  },
  {
    ...
    posts: [
      ...
      { slug: 'when-cardinals-appear-angels-are-near', title: 'When Cardinals Appear, Angels Are Near: The Meaning Behind the Belief', description: 'About the belief that cardinal sightings are signs from loved ones who have passed.' },
      { slug: 'sympathy-gifts-that-last', title: 'Sympathy Gifts That Last: Meaningful Ideas Beyond Flowers', description: 'Lasting sympathy gifts beyond flowers. Plants, keepsakes, donations, and gifts that keep showing up.' },
      { slug: 'what-to-plant-in-memory-of-someone', title: 'What to Plant in Memory of Someone: Trees, Flowers, and Living Tributes', description: 'A guide to memorial plants and trees, what each one symbolizes, and how to choose a living tribute.' },
      { slug: 'what-to-post-on-facebook-when-someone-dies', title: 'What to Post on Facebook When Someone Dies: Examples and What to Avoid', description: 'How to announce a death on Facebook with sensitivity. Examples, what to never post, and account settings.' },
      { slug: 'memorial-stepping-stones', title: 'Memorial Stepping Stones: Ideas, How to Make One, and Where to Buy', description: 'A guide to memorial stepping stones, how to design one, and how to make a custom stone at home.' },
      ...
      <main className="min-h-screen relative">
        ...
        <div className="relative z-10">
          <div className="max-w-5xl mx-auto px-4 py-12">
            ...
            <div className="mb-12">
              <h2 className="text-xl font-bold text-gray-900 mb-4">Free Writing Tools</h2>
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <Link href="/eulogy-writer" className="block bg-white border border-slate-200 rounded-lg p-5 hover:shadow-md transition-shadow">
                  <h3 className="text-lg font-semibold text-gray-900 mb-1">Free AI Eulogy Writer</h3>
                  <p className="text-sm text-gray-600">Generate a complete personalized eulogy in minutes. No writing experience needed.</p>
                </Link>
              </div>
            </div>
