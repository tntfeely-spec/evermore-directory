...
const categories: { name: string; subtitle?: string; posts: Post[] }[] = [
  ...
  },
  {
    ...
    posts: [
      { slug: 'funeral-cost-calculator', title: 'Funeral Cost Calculator: Estimate Costs by State (2026)', description: 'Real price ranges from 7,395+ funeral homes and cremation providers across all 50 states. Pick your state for instant estimates.' },
