...
export const metadata: Metadata = {
  title: 'Funeral Home Costs in Chicago, Illinois (2026)',
  description: 'Compare funeral home costs in Chicago, Illinois. Real cremation and burial price ranges from local providers. Updated 2026.',
  keywords: 'funeral home costs chicago, funeral costs chicago il, cremation cost chicago, burial cost chicago',
  robots: { index: true, follow: true },
  alternates: { canonical: 'https://funeralhomedirectories.com/blog/funeral-home-costs-chicago' },
  openGraph: { title: 'Funeral Home Costs in Chicago, Illinois (2026)', url: 'https://funeralhomedirectories.com/blog/funeral-home-costs-chicago', type: 'article' },
};
...
export default async function Page() {
  ...
  const faqs = [
    { q: 'How much does a funeral cost in Chicago?', a: `In Chicago, direct cremation ranges from ${cremRange} and traditional burial costs ${burialRange}. ${dataNote}` },
    { q: 'What is the cheapest funeral option in Chicago?', a: `Direct cremation is the most affordable option in Chicago, starting around ${pricing ? formatCurrency(pricing.cremationLow) : '$1,500'}. It includes transportation, cremation, and return of remains without a formal service.` },
    { q: 'How do I compare funeral prices in Chicago?', a: 'Browse the Evermore Directory to see all funeral homes in Chicago with contact information and services. Request a General Price List from each provider you are considering. Under the FTC Funeral Rule, every funeral home must provide one on request.' },
    { q: 'What payment options do Chicago funeral homes offer?', a: 'Many funeral homes in Chicago accept credit cards, offer payment plans, and work with insurance assignments. Some providers also accept VA burial benefits and Medicaid. Ask each provider about their specific payment options when requesting the General Price List.' },
    { q: 'What are my rights under the FTC Funeral Rule?', a: 'The FTC Funeral Rule requires every funeral home to provide an itemized General Price List, allow you to choose only the services you want, and not require a casket for cremation. These rights apply in every state including Illinois.' },
  ];

  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Funeral Home Costs in Chicago, Illinois (2026)","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-05-12","dateModified":"2026-05-12","url":"https://funeralhomedirectories.com/blog/funeral-home-costs-chicago"}) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://funeralhomedirectories.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://funeralhomedirectories.com/blog"},{"@type":"ListItem","position":3,"name":"Funeral Home Costs in Chicago, Illinois"}]}) }} />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <article>
            <header className="mb-10">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">Funeral Home Costs in Chicago, Illinois (2026)</h1>
              ...
              <p className="text-xl text-gray-600">Real funeral and cremation cost ranges for Chicago, Illinois.</p>
            </header>

            <section className="mb-10">
              <p className="text-gray-700 text-lg leading-relaxed mb-4">
                Funeral home costs in Chicago, Illinois range from {cremRange} for direct cremation and from {burialRange} for a traditional funeral with burial. {dataNote}
              </p>
              <p className="text-gray-600 mb-4">
                As a former firefighter and paramedic, I saw families in Chicago face these costs during the worst moments of their lives. The price ranges below are here so you can plan with real numbers, not guesses.
              </p>
            </section>

            <section className="mb-10">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Average Funeral Costs in Chicago (2026)</h2>
              <div className="overflow-x-auto mb-4">
                <table className="w-full border-collapse">
                  <thead><tr className="bg-gray-50 border-b border-gray-200"><th className="text-left px-4 py-3 font-semibold text-gray-700">Service Type</th><th className="text-left px-4 py-3 font-semibold text-gray-700">Chicago Average</th></tr></thead>
                  <tbody>
            ...
            <section className="mb-10">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Funeral Costs Vary in Chicago</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
                Funeral costs in Chicago are influenced by several factors. Urban markets like Chicago tend to have higher facility costs, which are passed on to families. The mix of providers matters too. National chains like SCI (Dignity Memorial) and StoneMor typically price at or above the market average, while independent family owned funeral homes and direct cremation specialists often offer more competitive pricing. Cost of living in the Chicago metro area directly affects staff wages and real estate costs for funeral home facilities. Competition also plays a role. Cities with more providers tend to have more price variation, which benefits families who compare options.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The best way to control costs is to request the General Price List from at least three providers in Chicago before making a decision. Under federal law, every funeral home must give you this list on request.
              </p>
            </section>

            <section className="mb-10">
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/funeral-homes/il/chicago" className="inline-block bg-slate-700 hover:bg-slate-800 text-white font-bold px-6 py-3 rounded-lg transition-colors text-center">Browse Funeral Homes in Chicago</Link>
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Compare Individual Funeral Homes in Chicago</h2>
              <p className="text-gray-600 mb-4">For a detailed comparison of specific funeral homes in Chicago, including addresses, phone numbers, and services, see our complete guide:</p>
              <Link href="/blog/funeral-homes-chicago-il" className="text-slate-600 hover:text-slate-800 font-medium">Funeral Homes in Chicago: Prices and Services</Link>
            </section>
            <section className="mb-10">
