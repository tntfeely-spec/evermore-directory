...
export default function ShortEulogyExamplesPage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Short Eulogy Examples: Brief Tributes Under 3 Minutes","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-15","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/short-eulogy-examples"}) }} />
