...
export default function AreFuneralExpensesTaxDeductiblePage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Are Funeral Expenses Tax Deductible? What Families Need to Know","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-14","dateModified":"2026-04-14","url":"https://funeralhomedirectories.com/blog/are-funeral-expenses-tax-deductible"}) }} />
