          ...
          <article>
            ...
            <section className="mb-10">
              ...
              <p className="text-gray-600">
                Evermore Directory has worked with families from every background in their most difficult moments. Faith matters deeply to many families at the end of life. This guide is written with that in mind.
              </p>
            </section>
