...
export default function ColumbariumGuidePage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Columbarium: What It Is and How Niche Burial Works","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-10","dateModified":"2026-04-10","url":"https://funeralhomedirectories.com/blog/columbarium-guide"}) }} />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <article>
            ...
            <section className="mb-10 bg-slate-50 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                <li><Link href="/blog/what-to-do-with-ashes-after-cremation" className="text-slate-600 hover:text-slate-800 font-medium">What to Do with Ashes After Cremation: 10 Options for F &rarr;</Link></li>
                <li><Link href="/blog/cremation-costs-2026" className="text-slate-600 hover:text-slate-800 font-medium">How Much Does Cremation Cost in 2026? State-by-State Pr &rarr;</Link></li>
                <li><Link href="/blog/scattering-ashes-guide" className="text-slate-600 hover:text-slate-800 font-medium">Scattering Ashes: Laws, Locations, and What Families Sh &rarr;</Link></li>
              </ul>
            </section>
          </article>
        </div>
