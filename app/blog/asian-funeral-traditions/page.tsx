...
export default function AsianFuneralTraditionsPage() {
  return (
    <>
      ...
      <Navigation />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Asian Funeral Traditions: Chinese, Korean, Vietnamese, and More","author":{"@type":"Person","name":"Terry Feely","url":"https://funeralhomedirectories.com/about"},"publisher":{"@type":"Organization","name":"Evermore Directory","url":"https://funeralhomedirectories.com"},"datePublished":"2026-04-14","dateModified":"2026-04-18","url":"https://funeralhomedirectories.com/blog/asian-funeral-traditions"}) }} />
          ...
          <article>
            ...
            <section className="mb-10 bg-slate-50 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/blog/european-funeral-traditions" className="text-slate-600 hover:text-slate-800 font-medium">European Funeral Traditions &rarr;</Link></li>
              </ul>
            </section>
