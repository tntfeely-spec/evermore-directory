            ...
            <section className="mb-10">
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse bg-white rounded">
                  ...
                  <tbody>
                    <tr><td className="border p-3">Direct Cremation</td><td className="border p-3">$1,200 – $3,500</td></tr>
                    ...
                    <tr><td className="border p-3">Full Funeral with Viewing</td><td className="border p-3">$7,000 – $14,000+</td></tr>
