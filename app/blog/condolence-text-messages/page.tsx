...
export default function CondolenceTextMessagesPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"HowTo","name":"How to Send a Condolence Text Message","description":"How to write a sincere condolence text and what to avoid.","step":[{"@type":"HowToStep","position":1,"name":"Send it promptly","text":"Send your condolence text within 24 to 48 hours of hearing the news. A timely message means more than a perfectly worded one sent days later."},{"@type":"HowToStep","position":2,"name":"Name the person who died","text":"Use the name of the person who died in your message. Saying I am so sorry about the loss of your mother feels far more personal than a generic sorry for your loss."},{"@type":"HowToStep","position":3,"name":"Keep it short","text":"A condolence text should be 2 to 4 sentences. This is not the place for a long message. Short and sincere is always better than long and generic."},{"@type":"HowToStep","position":4,"name":"Avoid hollow phrases","text":"Avoid everything happens for a reason, they are in a better place, or at least they are not suffering. These phrases often feel dismissive even when well-intentioned."},{"@type":"HowToStep","position":5,"name":"Do not expect a reply","text":"Make clear in your text that no response is needed. Add a line like no need to reply, just wanted you to know I am thinking of you."}]}) }} />
      <Navigation />
