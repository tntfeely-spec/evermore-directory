...
export const metadata: Metadata = {
  ...
  description: 'A practical, compassionate guide to writing an obituary -- what to include, how to structure it, how long it should be, and example opening lines that work.',
  keywords: 'how to write an obituary, obituary template, obituary examples, writing an obituary, obituary guide, what to include in an obituary',
  alternates: {
    canonical: 'https://funeralhomedirectories.com/blog/how-to-write-an-obituary',
  },
};
          ...
          <article>
            <header className="mb-10">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                How to Write an Obituary: A Simple Guide With Examples
              </h1>
