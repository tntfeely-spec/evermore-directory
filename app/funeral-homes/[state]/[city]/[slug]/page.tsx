...
function buildSectionsHtml(listing: FuneralHome, services: string[], calcId: string, hasPricing: boolean, cityLabel: string): string {
  ...
  const photoImg = listing.photo_url
    ...
    : `<div style="position:relative;"><img src="/Sunlight_Forest.webp" alt="${fallbackAlt}" style="width:100%;height:280px;object-fit:cover;border-radius:8px;display:block;" loading="lazy" /><div style="position:absolute;bottom:12px;left:50%;transform:translateX(-50%);background:rgba(0,0,0,0.55);color:white;font-size:13px;padding:5px 14px;border-radius:20px;white-space:nowrap;">Photo coming soon</div></div>`
