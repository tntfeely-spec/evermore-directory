...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const blogPosts = [
    ...
    'funeral-financial-assistance-texas',
    'funeral-financial-assistance-california',
    'funeral-financial-assistance-florida',
    'funeral-financial-assistance-ohio',
    'funeral-financial-assistance-georgia',
    'wichita-obituaries',
    ...
    'best-memorial-gifts',
    'direct-cremation-cost-atlanta',
    'direct-cremation-cost-chicago',
    'direct-cremation-cost-dallas',
    'direct-cremation-cost-houston',
    'direct-cremation-cost-jacksonville',
    'direct-cremation-cost-los-angeles',
    'direct-cremation-cost-philadelphia',
    'direct-cremation-cost-phoenix',
    'direct-cremation-cost-san-antonio',
    'direct-cremation-cost-san-diego',
    'fema-funeral-assistance',
    'funeral-announcement-wording-templates',
    'funeral-home-costs-atlanta',
    'funeral-home-costs-chicago',
    'funeral-home-costs-dallas',
    'funeral-home-costs-houston',
    'funeral-home-costs-jacksonville',
    'funeral-home-costs-los-angeles',
    'funeral-home-costs-philadelphia',
    'funeral-home-costs-phoenix',
    'funeral-home-costs-san-antonio',
    'funeral-home-costs-san-diego',
    'funeral-poems-for-mothers',
    'gofundme-funeral-template',
    'how-to-plan-a-funeral',
    'funeral-costs-2026',
    'what-to-do-when-someone-dies',
    'burial-vs-cremation',
    'funeral-cost-tennessee-2026',
    'funeral-home-red-flags',
    'funeral-homes-near-me',
    'green-burial-options-guide',
    'how-direct-cremation-works',
    'military-funeral-honors-color-guard-explained',
    'national-cemetery-burial-veterans-free',
    'pre-planning-a-funeral',
    'traditional-vs-celebration-of-life',
    'va-burial-benefits-veterans-guide',
